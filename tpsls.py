...
def rpsls(player_choice):
    ...
    computer_answer = number_to_name(comp_number)# 调用number_to_name()函数将计算机产生的随机数转换为对应的游戏对象

    print(computer_answer)# 在屏幕上显示计算机选择的随机对象
    ...
    return rpsls# 如果用户和计算机选择一样，则显示“您和计算机出的一样呢”，如果用户获胜，则显示“您赢了”，反之则显示“计算机赢了”
